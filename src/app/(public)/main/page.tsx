  ...
  useGSAP(
    () => {
      ...
      gsap.fromTo(
        ...
        { yPercent: 0, xPercent:50 , autoAlpha: 1, duration: 1.5, ease: "power3.out", delay: 8 }
      );
      ...
      const onClick = () => runScrambleSequence();
      window.addEventListener("click", onClick);

      // 처음 한 번 자동 실행하고 싶으면 켜기
      runScrambleSequence();
  ...
  return (
    <div ref={root} className="p-0 m-0">
      <div className="w-screen h-screen relative overflow-hidden p-0 m-0">
        ...
        <div className="text-scramble__content absolute top-0 right-0 p-6 z-20">
        ...
        <div className="dis3 w-screen h-1/5 bg-gray-200 absolute p-0 m-0"></div>
        <div className="dis4 w-screen h-screen absolute p-0 m-0 z-10">
            <Image src="/images/123321.png" alt="img" width={400} height={300}/>
        </div>
